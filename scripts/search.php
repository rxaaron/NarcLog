    ...
    if (!$db){
        ...
        if ($query){
            ...
            while($results=$query->fetch_object()){
                echo "<tr><td><a href=\"#\" onclick=\"return resultlist('".$results->ID."','".$action."')\">".$results->Drug." ".$results->Indicator."</a></td><td>".$results->Strength."</td><td>".$results->Form."</td><td>".$results->Comments."</td></tr>";
            }
            echo "</table>";
        }else{
