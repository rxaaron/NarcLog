<?php
    ...
    if (!$db){
        ...
        if($action!="edit"){
            ...
            if ($query){
                if($query->num_rows!=0){
                    echo "<table id=\"searchtable\"><colgroup><col class=\"drugname\"><col class=\"drugstrength\"><col class=\"drugform\"><col class=\"drugcomments\"></colgroup><tr><th>Drug Name</th><th>Strength</th><th>Form</th><th>Comments</th></tr>";
                    $c=true;
