...
if (!$db) {
    echo 'ERROR: Could not connect to the database.';
        ...
        //check permissions
    $perms=$db->query("SELECT A.DrugEdit FROM ".$store_prefix."_Permissions AS A INNER JOIN Employee AS B ON A.EmployeeID=B.ID WHERE B.Password = '".$_POST['empidadd']."' AND A.Active=TRUE;");
